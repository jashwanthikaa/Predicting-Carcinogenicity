...
# Load dataset
df <- read_excel("C:/Users/91962/Predicting Carcinogencity/FinalData.xlsx")
...
write.csv(results, "xgb_model_predictions_lessdata_optimized100(1).csv", row.names = FALSE)
