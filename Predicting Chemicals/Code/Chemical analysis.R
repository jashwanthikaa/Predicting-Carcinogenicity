# title: "Comptox Database"

setwd("C:/Users/91962/Predicting-Toxicity/")
df = read.csv("D1.csv")
...
breakdown = makeup(df$MOLECULAR_FORMULA,count.zero = TRUE)

moleculecount = as.data.frame(do.call(rbind, breakdown))
final <- cbind(df, moleculecount)
write_xlsx(final, "Dataset.xlsx")
...
df2 = Fingerprint_calc(df1)
write_xlsx(df2, "df2_final.xlsx")
