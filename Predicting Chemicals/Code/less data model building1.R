...
write.csv(results, "xgb_model_predictions1.csv", row.names = FALSE)

# Plot ROC curve
plot(roc_obj, col = "blue", main = "ROC Curve for XGBoost Model1")

dev.copy(pdf, "C:/Users/91962/Predicting Chemicals/roc_xgboost1.pdf",
         width = 7, height = 5)
dev.off()