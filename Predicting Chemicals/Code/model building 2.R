...
write.csv(results, "xgb_model_predictions2.csv", row.names = FALSE)

# Plot ROC curve
plot(roc_obj, col = "blue", main = "ROC Curve for XGBoost Model2")
png("ROC_Model2.png", width = 1200, height = 800, res = 150)
plot(roc_obj, col = "blue", main = "ROC Curve for XGBoost Model2")
dev.off()
